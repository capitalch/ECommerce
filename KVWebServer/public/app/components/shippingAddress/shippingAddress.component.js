...
var ShippingAddress = (function () {
    ...
    ;
    // validateUSAddressAsync(group) {
    //     let pr = new Promise((resolve, reject) => {
    //         this.appService.filterOn('get:smartyStreet').take(1).subscribe(d => {
    //             if (d.data.error) {
    //                 resolve({ "addressValidationUnauthorized": true });
    //             } else {
    //                 if (d.data.length == 0) {
    ...
    //         });
    //         let usAddress = {
    //             street: group.value.street1,
    //             street2: group.value.street2,
    //             city: group.value.city,
    //             state: group.value.state,
    //             zipcode: group.value.zip
    //         };
