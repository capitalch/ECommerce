...
var AppService = (function () {
        ...
        this.settingsSubscription = this
            ...
            if (d.data.error) {
                ...
                if (data.Table) {
                    ...
                    _this.globalSettings.creditCardTypes = data
                        .Table[0]
                        .creditCardTypes
                        .split(",")
                        .map(function (item) {
    ...
    AppService.prototype.httpDelete = function (id, body) {
        ...
        this
            ...
            .map(function (response) { return response.json(); })
            .subscribe(function (d) { return _this.subject.next({ id: id, data: d, index: body.index }); }, function (err) { return _this.subject.next({
            id: id,
            data: {
                error: err
            }
    ...
    AppService.prototype.httpPut = function (id, body) {
        ...
        this
            ...
            .map(function (response) { return response.json(); })
            .subscribe(function (d) { return _this.subject.next({ id: id, data: d, body: body }); }, function (err) { return _this.subject.next({
            id: id,
            data: {
                error: err
            }
...
var LoginGuard = (function () {
    ...
    LoginGuard.prototype.isLoggedIn = function (token) {
        ...
        return obs.map(function (success) {
